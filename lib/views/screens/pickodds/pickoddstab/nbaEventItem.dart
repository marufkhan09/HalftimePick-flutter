...
class NbaEventItem extends StatefulWidget {
  final NbaGamesData events;

  const NbaEventItem({super.key, required this.events});

  @override
  State<NbaEventItem> createState() => _NbaEventItemState();
}

class _NbaEventItemState extends State<NbaEventItem> {
