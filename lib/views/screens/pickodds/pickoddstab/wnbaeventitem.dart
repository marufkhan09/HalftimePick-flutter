...
class WnbaEventItem extends StatefulWidget {
  final WnbaGamesData events;
  ...
  @override
  State<WnbaEventItem> createState() => _WnbaEventItemState();
}

class _WnbaEventItemState extends State<WnbaEventItem> {
