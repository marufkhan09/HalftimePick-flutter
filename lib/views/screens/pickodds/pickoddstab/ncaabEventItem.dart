...
class NcaabEventItem extends StatefulWidget {
  final NcaabGamesData events;

  const NcaabEventItem({
    super.key,
    required this.events,
  });

  @override
  State<NcaabEventItem> createState() => _NcaabEventItemState();
}

class _NcaabEventItemState extends State<NcaabEventItem> {
