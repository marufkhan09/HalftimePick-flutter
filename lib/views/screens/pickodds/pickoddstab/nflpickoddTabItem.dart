...
class NFLPickOddstabItem extends StatefulWidget {
  final NflGameData events;
  const NFLPickOddstabItem({super.key, required this.events});

  @override
  State<NFLPickOddstabItem> createState() => _NFLPickOddstabItemState();
}

class _NFLPickOddstabItemState extends State<NFLPickOddstabItem> {
        ...
        child: Column(
          ...
          children: [
            ...
            widget.events.isPick!
                ? InkWell(
                    onTap: () {
                      UrlLauncher.launch(widget.events.url.toString());
                    },
                    child: Container(
                      alignment: Alignment.center,
