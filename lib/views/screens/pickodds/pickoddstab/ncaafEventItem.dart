...
class NcaafEventItem extends StatefulWidget {
  final NcaafGamesData events;

  const NcaafEventItem({
    super.key,
    required this.events,
  });

  @override
  State<NcaafEventItem> createState() => _NcaafEventItemState();
}

class _NcaafEventItemState extends State<NcaafEventItem> {
