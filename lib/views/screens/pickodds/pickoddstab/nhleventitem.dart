...
class NhlEventItem extends StatefulWidget {
  final NhlGamesData events;
  ...
  @override
  State<NhlEventItem> createState() => _NhlEventItemState();
}

class _NhlEventItemState extends State<NhlEventItem> {
